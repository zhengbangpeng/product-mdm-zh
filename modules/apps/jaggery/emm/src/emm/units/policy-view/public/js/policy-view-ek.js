        ...
        if (configuredOperations.length == 0) {
            ...
            if ($.inArray(iosOperationConstants["WIFI_OPERATION_CODE"], configuredOperations) != -1) {
                ...
                if (!wifiSSID && !wifiDomainName) {
                    validationStatus = {
                        "error": true,
                        "subErrorMsg": "Wi-Fi SSID 和 Wi-Fi 域名不能同时为空",
                        "erroneousFeature": operation
                    };
                    continueToCheckNextInputs = false;
                }
                        ...
                        if (continueToCheckNextInputs) {
                            ...
                            if ($(wifiTLSTrustedServerNamesGridChildInputs).length > 0) {
                                ...
                                if (emptyChildInputCount > 0) {
                                    ...
                                    validationStatus = {
                                        "error": true,
                                        "subErrorMsg": "TLS Trusted Server Names 重复输入",
                                        "erroneousFeature": operation
                                    };
                                    continueToCheckNextInputs = false;
                                }
                ...
                if (continueToCheckNextInputs) {
                    ...
                    if ($(wifiRoamingConsortiumOIsGridChildInputs).length > 0) {
                        ...
                        if (emptyChildInputCount > 0) {
                            ...
                            validationStatus = {
                                "error": true,
                                "subErrorMsg": "ORoaming Consortium OIs 不能为空",
                                "erroneousFeature": operation
                            };
                            continueToCheckNextInputs = false;
                            ...
                            validationStatus = {
                                "error": true,
                                "subErrorMsg": "ORoaming Consortium OIs 重复输入",
                                "erroneousFeature": operation
                            };
                            continueToCheckNextInputs = false;
                ...
                if (continueToCheckNextInputs) {
                    ...
                    if ($(wifiNAIRealmNamesGridChildInputs).length > 0) {
                        ...
                        if (emptyChildInputCount > 0) {
                            ...
                            validationStatus = {
                                "error": true,
                                "subErrorMsg": "ONAI Realm Names 不能为空",
                                "erroneousFeature": operation
                            };
                            continueToCheckNextInputs = false;
                        } else if (duplicatesExist) {
                ...
                if (continueToCheckNextInputs) {
                    if ($(airplayDestinationsGridChildInputs).length > 0) {
                        ...
                        if (emptyChildInputCount > 0) {
                            ...
                            validationStatus = {
                                "error": true,
                                "subErrorMsg": "AirPlay Destinations 无效",
                                "erroneousFeature": operation
                            };
                            continueToCheckNextInputs = false;
                        }
